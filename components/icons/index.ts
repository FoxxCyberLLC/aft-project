// Custom SVG Icon Library - Minimalist, professional icons mimicking Lucide style
...
function Icon(svg: string, props: IconProps = {}): string {
...
export const FolderOpenIcon = (props?: IconProps) =>
  Icon(
    `
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="">
    <path d="m6 14 1.45-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.55 6a2 2 0 0 1-1.94 1.5H4a2 2 0 0 1-2-2V5c0-1.1.9-2 2-2h5l2 3h7a2 2 0 0 1 2 2v2"/>
  </svg>
`,
    props,
  );
...
export const BugIcon = (props?: IconProps) =>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="">
    ...
    <path d="m9 6-3 3v7l3 3"/>
    <path d="m15 6 3 3v7l-3 3"/>
    <path d="M3 12h2"/>
    <path d="M19 12h2"/>
    <path d="M12 2v4"/>
    <path d="M6 8h12"/>

...
import { ClipboardIcon, HomeIcon, ListIcon, PlusIcon } from '../components/icons';
...
const NAV_ITEMS: RequestorNavItem[] = [
...
function getNavItems(currentPath: string): RequestorNavItem[] {
...
export const RequestorNavigation = {
  getNavItems,
  renderNavigation,
  renderPageHeader,
  renderLayout,

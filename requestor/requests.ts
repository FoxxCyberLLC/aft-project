...
async function render(
  ...
  const tableContainer = ComponentBuilder.tableContainer({
    title: 'My Requests',
    description:
      'All your AFT requests are listed here. You can track their status and manage them.',
    table,
  });
...
function getStatusVariant(status: string): 'default' | 'info' | 'success' | 'error' | 'warning' {
...
export const RequestorRequests = {
  render,
  getScript,
};

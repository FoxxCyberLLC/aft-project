...
const NAV_ITEMS: ApproverNavItem[] = [
...
function getNavItems(currentPath: string): ApproverNavItem[] {
  return NAV_ITEMS.map((item) => ({
    ...item,
    active:
      currentPath === item.href || (item.href !== '/approver' && currentPath.startsWith(item.href)),
  }));
}
